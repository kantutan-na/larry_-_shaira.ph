								...
								<table class="table datanew">
									...
									<tbody>
										...
										<tr>
											...
											<td>12/10/2024</td>
											<td>Colgate-Palmolive Philippines</td>
											<td>PT006</td>
											<td><span class="badges bg-lightgreen">Received</span></td>
											<td>0.00</td>
											<td>0.00</td>
										...
										<tr>
											...
											<td>12/10/2024</td>
											<td>Johnson & Johnson Philippines</td>
											<td>PT007</td>
											<td><span class="badges bg-lightyellow">Ordered</span></td>
											<td>0.00</td>
											<td>0.00</td>
										...
										<tr>
											...
											<td>12/10/2024</td>
											<td>Liwayway Marketing Corporation (Oishi)</td>
											<td>PT009</td>
											<td><span class="badges bg-lightred">Pending</span></td>
											<td>0.00</td>
											<td>0.00</td>
											...
											<div class="row">
												...
												<div class="col-lg-12 col-sm-6 col-12">
													<div class="input-blocks">
														<label>Product Name</label>
														<div class="input-groupicon select-code">
															<input type="text" placeholder="Please type product code and select" value="#">
															<div class="addonset">
																<img src="assets/img/icons/qrcode-scan.svg" alt="img">
															</div>
														</div>
