							...
							<div class="chat-header">
								...
								<div class="chat-options ">
									<ul class="list-inline">
										...
										<li class="list-inline-item" >
											<a href="video-call.php" class="btn btn-outline-light" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Video Call">
												<i class="bx bx-video" ></i>
											</a>
										</li>
										<li class="list-inline-item" >
											<a href="audio-call.php" class="btn btn-outline-light" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Voice Call">
										...
										<div class="text-center right-sidebar-profile">
											...
											<div class="chat-options chat-option-profile">
												<ul class="list-inline">
													...
													<li class="list-inline-item " >
														<a href="video-call.php" class="btn btn-outline-light profile-open" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Video Call">
															<i class="bx bx-video" ></i>
														</a>
													</li>
													<li class="list-inline-item" >
							...
							<div class="modal-body custom-modal-body">
								...
								<div class="col-lg-12">
									...
									<div class="col-lg-12">
										<div class="modal-footer-btn">
											<a href="javascript:void(0);" class="btn btn-cancel me-2" data-bs-dismiss="modal">Cancel</a>
											<a href="purchase-list.php" class="btn btn-submit">Submit</a>
										</div>
									</div>
							</div>
						</div>
