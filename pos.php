						...
						<div class="col-md-12 col-lg-8">
							<div class="pos-categories tabs_wrapper">
								...
								<ul class="tabs owl-carousel pos-category">
									...
									<li id="beverages">
										<a href="javascript:void(0);">
											<img src="assets/img/products/drinks.png" alt="Categories">
										</a>
										<h6><a href="javascript:void(0);">Beverages</a></h6>
										<span>4 Items</span>
									</li>
									<li id="wines-liquors">
										<a href="javascript:void(0);">
											<img src="assets/img/products/wine-bottles.png" alt="Categories">
										</a>
										<h6><a href="javascript:void(0);">Wines & Liquors</a></h6>
										<span>14 Items</span>
									</li>
									<li id="snacks">
										<a href="javascript:void(0);">
											<img src="assets/img/products/snacks.png" alt="Categories">
										</a>
										<h6><a href="javascript:void(0);">Snacks</a></h6>
										<span>7 Items</span>
									</li>
									<li id="sweets">
										<a href="javascript:void(0);">
											<img src="assets/img/products/sweets.png" alt="Categories">
										</a>
										<h6><a href="javascript:void(0);">Sweets</a></h6>
										<span>16 Items</span>
									</li>
									<li id="milk-milk-products">
										<a href="javascript:void(0);">
											<img src="assets/img/products/milk.png" alt="Categories">
										</a>
										<h6><a href="javascript:void(0);">Milk & Milk Products</a></h6>
										<span>18 Items</span>
									</li>
									<li id="allcategory">
										<a href="javascript:void(0);">
										...
										<div  class="tab_content active" data-tab="all">
											<div class="row">
												<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3">
													<div class="product-info default-cover card">
														<a href="javascript:void(0);" class="img-bg">
															<img src="assets/img/products/pos/piattos.png" alt="Products">
															<span><i data-feather="check" class="feather-16"></i></span>
														</a>
														<h6 class="cat-name"><a href="javascript:void(0);">SNACKS</a></h6>
														<h6 class="product-name"><a href="javascript:void(0);">JACK N JILL PIATTOS CHEESE 40G</a></h6>
												...
												<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
													<div class="product-info default-cover card">
														<a href="javascript:void(0);" class="img-bg">
															<img src="assets/img/products/pos/cobra.png" alt="Products">
															<span><i data-feather="check" class="feather-16"></i></span>
														</a>
														<h6 class="cat-name"><a href="javascript:void(0);">BEVERAGES</a></h6>
														<h6 class="product-name"><a href="javascript:void(0);">COBRA ENERGY DRINK ORIGINAL 350ML</a></h6>
														<div class="d-flex align-items-center justify-content-between price">
															<span>140 Pcs</span>
															<p>₱21.10</p>
														</div>
												...
												<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
													<div class="product-info default-cover card">
														<a href="javascript:void(0);" class="img-bg">
															<img src="assets/img/products/pos/kopiko-black.png" alt="Products">
															<span><i data-feather="check" class="feather-16"></i></span>
														</a>
														<h6 class="cat-name"><a href="javascript:void(0);">BEVERAGES</a></h6>
														<h6 class="product-name"><a href="javascript:void(0);">KOPIKO BLACK3IN1 <br> HANGER 30GX10S</a></h6>
														<div class="d-flex align-items-center justify-content-between price">
															<span>50 Pcs</span>
															<p>₱78.00</p>
														</div>
												...
												<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
													<div class="product-info default-cover card">
														<a href="javascript:void(0);" class="img-bg">
															<img src="assets/img/products/pos/coffee-mate.png" alt="Products">
															<span><i data-feather="check" class="feather-16"></i></span>
														</a>
														<h6 class="cat-name"><a href="javascript:void(0);">BEVERAGES</a></h6>
														<h6 class="product-name"><a href="javascript:void(0);">NESTLE COFFEMATE<br>ORIGINAL 150G</a></h6>
														<div class="d-flex align-items-center justify-content-between price">
															<span>450 Pcs</span>
															<p>₱49.25</p>
														</div>
												...
												<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
													<div class="product-info default-cover card">
														<a href="javascript:void(0);" class="img-bg">
															<img src="assets/img/products/pos/nata-de-coco.png" alt="Products">
															<span><i data-feather="check" class="feather-16"></i></span>
														</a>
														<h6 class="cat-name"><a href="javascript:void(0);">GROCERY STAPLES</a></h6>
														<h6 class="product-name"><a href="javascript:void(0);">PURE BASICS NATA DE COCO WHITE 340G</a></h6>
														<div class="d-flex align-items-center justify-content-between price">
															<span>17 Pcs</span>
															<p>₱60.00</p>
														</div>
												...
												<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
													<div class="product-info default-cover card">
														<a href="javascript:void(0);" class="img-bg">
															<img src="assets/img/products/pos/knorr.png" alt="Products">
															<span><i data-feather="check" class="feather-16"></i></span>
														</a>
														<h6 class="cat-name"><a href="javascript:void(0);">GROCERY STAPLES</a></h6>
														<h6 class="product-name"><a href="javascript:void(0);">KNORR SOUP CREAM OF MUSHROOM 62G</a></h6>
														<div class="d-flex align-items-center justify-content-between price">
															<span>20 Pcs</span>
															<p>₱55.85</p>
														</div>
												...
												<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
													<div class="product-info default-cover card">
														<a href="javascript:void(0);" class="img-bg">
															<img src="assets/img/products/pos/kool-fever.png" alt="Products">
															<span><i data-feather="check" class="feather-16"></i></span>
														</a>
														<h6 class="cat-name"><a href="javascript:void(0);">HEALTH CARE</a></h6>
														<h6 class="product-name"><a href="javascript:void(0);">KOOL FEVER COOLING GEL FOR KIDS 2S</a></h6>
														<div class="d-flex align-items-center justify-content-between price">
															<span>10 Pcs</span>
															<p>₱52.80</p>
														</div>
												...
												<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
													<div class="product-info default-cover card">
														<a href="javascript:void(0);" class="img-bg">
															<img src="assets/img/products/pos/noodles.png" alt="Products">
															<span><i data-feather="check" class="feather-16"></i></span>
														</a>
														<h6 class="cat-name"><a href="javascript:void(0);">GROCERY STAPLES</a></h6>
														<h6 class="product-name"><a href="javascript:void(0);">LUCKY ME! INSTANT MAMI SPICY LABUYO CHICKEN 50G</a></h6>
														<div class="d-flex align-items-center justify-content-between price">
															<span>14 Pcs</span>
															<p>₱9.85</p>
														</div>
												...
												<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
													<div class="product-info default-cover card">
														<a href="javascript:void(0);" class="img-bg">
															<img src="assets/img/products/pos/rice.png" alt="Products">
															<span><i data-feather="check" class="feather-16"></i></span>
														</a>
														<h6 class="cat-name"><a href="javascript:void(0);">RICE & SUGAR</a></h6>
														<h6 class="product-name"><a href="javascript:void(0);">FAMILIA PANDAN FIESTA RICE 25KG</a></h6>
														<div class="d-flex align-items-center justify-content-between price">
															<span>5 Pcs</span>
															<p>₱1,460.00</p>
														</div>
												...
												<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
													<div class="product-info default-cover card">
														<a href="javascript:void(0);" class="img-bg">
															<img src="assets/img/products/pos/pochi.png" alt="Products">
															<span><i data-feather="check" class="feather-16"></i></span>
														</a>
														<h6 class="cat-name"><a href="javascript:void(0);">SWEETS</a></h6>
														<h6 class="product-name"><a href="javascript:void(0);">POTCHI STRAWBERRY CREAM 50S</a></h6>
														<div class="d-flex align-items-center justify-content-between price">
															<span>40 Pcs</span>
															<p>₱35.30</p>
														</div>
									...
									<div class="product-wrap">
										<div class="product-list d-flex align-items-center justify-content-between">
											<div class="d-flex align-items-center product-info" data-bs-toggle="modal" data-bs-target="#products">
												<a href="javascript:void(0);" class="img-bg">
													<img src="assets/img/products/4800016644801.jpg" alt="Products">
												</a>
												<div class="info">
													<span>20721-118-4800016644801</span>
													<h6><a href="javascript:void(0);">JACK N JILL PIATTOS CHEESE 40G</a></h6>
													<p>₱15.40</p>
												</div>
											</div>
										...
										<div class="product-list d-flex align-items-center justify-content-between">
											<div class="d-flex align-items-center product-info" data-bs-toggle="modal" data-bs-target="#products">
												<a href="javascript:void(0);" class="img-bg">
													<img src="assets/img/products/4800611546760.jpg" alt="Products">
												</a>
												<div class="info">
													<span>236900-118-480061154676</span>
													<h6><a href="javascript:void(0);">COBRA ENERGY DRINK ORIGINAL 350ML</a></h6>
													<p>₱21.10</p>
												</div>
											</div>
											<div class="qty-item text-center">
										...
										<div class="product-list d-flex align-items-center justify-content-between">
											<div class="d-flex align-items-center product-info" data-bs-toggle="modal" data-bs-target="#products">
												<a href="javascript:void(0);" class="img-bg">
													<img src="assets/img/products/8996001410226.jpg" alt="Products">
												</a>
												<div class="info">
													<span>219024-118-8996001410226</span>
													<h6><a href="javascript:void(0);">KOPIKO BLACK3IN1 HANGER 30GX10S</a></h6>
													<p>₱78.00</p>
												</div>
											</div>
											<div class="qty-item text-center">
										...
										<div class="product-list d-flex align-items-center justify-content-between">
											<div class="d-flex align-items-center product-info" data-bs-toggle="modal" data-bs-target="#products">
												<a href="javascript:void(0);" class="img-bg">
													<img src="assets/img/products/4800361390804.jpg" alt="Products">
												</a>
												<div class="info">
													<span>453489-118-4800361390804</span>
													<h6><a href="javascript:void(0);">NESTLE COFFEMATE ORIGINAL 150G</a></h6>
													<p>₱49.25</p>
												</div>
											</div>
											<div class="qty-item text-center">
										...
										<div class="row">
											<div class="col-12 col-sm-4">
												<div class="input-block">
													...
													<option>VAT 0% (Zero-rated)</option>
											...
											<div class="col-12 col-sm-4">
												<div class="input-block">
													...
													<select class="select">
													<option>Local Pickup - ₱50</option>
													<option>Standard Delivery - ₱150</option>
													<option>Express Delivery - ₱250</option>
													<option>Free Shipping (Orders over ₱1000)</option>
									...
									<div class="order-total">
										<table class="table table-responsive table-borderless">
											...
											<tr>
												...
												<td class="danger text-end">₱0.00</td>
											</tr>
											<tr>
												<td>Total</td>
												<td class="text-end">₱0.00</td>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="text-center info text-center">
							<h6>LastMinuteDesigners Technologies Pvt Ltd.,</h6>
						...
						<div class="tax-invoice">
							...
							<div class="row">
								<div class="col-sm-12 col-md-6">
									<div class="invoice-user-name"><span>Name: </span><span>Juan Dela Criz</span></div>
								...
								<div class="col-sm-12 col-md-6">
									...
									<div class="invoice-user-name"><span>Date: </span><span>10.05.2024</span></div>
								</div>
							</div>
						</div>
						<table class="table-borderless w-100 table-fit">
							...
							<tbody>
								<tr>
									<td>1. JACK N JILL PIATTOS CHEESE 40G</td>
									<td>₱15.40</td>
									<td>2</td>
									<td class="text-end">₱0.00</td>
								</tr>
								<tr>
									<td>2. COBRA ENERGY DRINK ORIGINAL 350ML</td>
									<td>₱21.10</td>
									<td>2</td>
									<td class="text-end">₱0.00</td>
								</tr>
								<tr>
									<td>3. KOPIKO BLACK3IN1 HANGER 30GX10S</td>
									<td>₱78.00</td>
									<td>3</td>
									<td class="text-end">₱0.00</td>
								</tr>
						...
						<div class="text-center invoice-bar">
							<p>**VAT is payable through BIR-registered tax channels. Thank you for choosing L & S Store! Your business is important to us!</p>
							<a href="javascript:void(0);">
												...
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Date</td>
															<td class="colon">:</td>
															<td class="text">10-05-2024 13:39:11</td>
														</tr>
													</table>
												</div>
											</div>
												...
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Date</td>
															<td class="colon">:</td>
															<td class="text">10-05-2024 15:59:11</td>
														</tr>
													</table>
												</div>
											</div>
												...
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Date</td>
															<td class="colon">:</td>
															<td class="text">10-05-2024 13:15:00</td>
														</tr>
													</table>
												</div>
											</div>
												...
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Date</td>
															<td class="colon">:</td>
															<td class="text">10-05-2024 17:15:11</td>
														</tr>
													</table>
												</div>
											</div>
												...
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Customer</td>
															<td class="colon">:</td>
															<td class="text">Jejomar Binay</td>
														</tr>
													</table>
												</div>
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Date</td>
															<td class="colon">:</td>
															<td class="text">10-05-2024 14:50:11</td>
														</tr>
													</table>
												</div>
											</div>
												...
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Customer</td>
															<td class="colon">:</td>
															<td class="text">Rodrigo Duterte</td>
														</tr>
													</table>
												</div>
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Date</td>
															<td class="colon">:</td>
															<td class="text">10-05-2024 17:22:11</td>
														</tr>
													</table>
												</div>
											</div>
												...
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Customer</td>
															<td class="colon">:</td>
															<td class="text">Bong Bong Marcos</td>
														</tr>
													</table>
												</div>
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Date</td>
															<td class="colon">:</td>
															<td class="text">13-09-2024 19:39:11</td>
														</tr>
													</table>
												</div>
											</div>
												...
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Date</td>
															<td class="colon">:</td>
															<td class="text">15-06-2024 18:39:11</td>
														</tr>
													</table>
												</div>
											</div>
												...
												<div class="col-sm-12 col-md-6 record mb-3">
													<table>
														...
														<tr>
															<td>Date</td>
															<td class="colon">:</td>
															<td class="text">15-06-2024 19:39:11</td>
														</tr>
													</table>
												</div>
											</div>
