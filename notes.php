					...
					<div class="page-header page-add-notes  flex-sm-row flex-column">
						...
						<div class="d-flex flex-sm-row flex-column align-items-sm-center align-items-start">
							...
							<ul class="table-top-head">
								<li>
									<a href="notes.php" data-bs-toggle="tooltip" data-bs-placement="top" title="Refresh"><i data-feather="rotate-ccw" class="feather-rotate-ccw"></i></a>
								</li>
								<li>
													...
													<div class="notes-card">
														...
														<div class="notes-slider-widget">
															<div class="notes-logo">
																<a href="javascript:void(0);">
																	<span>
																		<img src="./assets/img/profiles/profile-01.png" alt="Profile" class="img-fluid">
																	</span>																	
																</a>	
																<div class="d-flex">
													...
													<div class="notes-card medium">
														...
														<div class="notes-slider-widget">
															<div class="notes-logo">
																<a href="javascript:void(0);">
																	<span>
																		<img src="./assets/img/profiles/profile-02.png" alt="Profile" class="img-fluid">
																	</span>
																</a>
																<div class="d-flex">
													...
													<div class="notes-card high">
														...
														<div class="notes-slider-widget">
															<div class="notes-logo">
																<a href="javascript:void(0);">
																	<span>
																		<img src="./assets/img/profiles/profile-03.png" alt="Profile" class="img-fluid">
																	</span>
																</a>
																<div class="d-flex">
