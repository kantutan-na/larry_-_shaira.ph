                                ...
                                <div class="col-lg-6">
                                    <form class="mb-0">
                                        ...
                                        <select class="select">
                                            ...
                                            <option>Letter (8.5 x 11 inches)</option>
                                            <option>Legal (8.5 x 14 inches)</option>
                                            <option>Receipt (80 x 200 mm)</option>
                                   ...
                                   <div class="d-flex justify-content-end">
                                       <a href="javascript:void(0);" class="btn btn-cancel close-btn">
                                        ...
                                        <div class="barcode-scan-header">
                                            <h5>JACK N JILL PIATTOS <br>CHEESE 40G</h5>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="barcode-scanner-link text-center">
                                                    ...
                                                    <div class="barscaner-img">
                                                        <img src="./assets/img/barcode/barcode-01.png" alt="Barcode" class="img-fluid">
                                                    </div>                                           
                                                </div>                                                
                                            </div>
                                        </div>   
                                        ...
                                        <div class="barcode-scan-header">
                                            <h5>COBRA ENERGY DRINK ORIGINAL 350ML</h5>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="barcode-scanner-link text-center">
                                                    ...
                                                    <p>Price: ₱21.10</p> 
                                                    <div class="barscaner-img">
                                                        <img src="./assets/img/barcode/barcode-02.png" alt="Barcode" class="img-fluid">
                                                    </div>                                           
                                                </div>                                                
                                            </div>
                                            <div class="col-sm-4">
